...
```
![image](https://github.com/user-attachments/assets/c06b92dc-4e9b-4ec4-9fee-1c3b87439b4d)
```sql
# emp 테이블에서 ename의 두 번째 문자를 '*'로 바꿔서 출력
select replace(ename,str(ename, 2, 1), '*') from emp;
```
![image](https://github.com/user-attachments/assets/a6ba8b71-17fd-4b6c-9928-8a25b6fbacab)
- nvl(var, value): var의 값(컬럼 이름)이 null이면 value를 반환(return)하고, 그렇지 않으면 var를 반환
```sql
select comm, nvl(comm, -1) from emp;
```
![image](https://github.com/user-attachments/assets/5f074c66-ec89-4ebc-be0c-d13d0b049488)
- nvl2(var, value1, value2): var의 값이 null이 아니면 value1을 반환하고, null이면 value2를 반환
```sql
select comm, nvl2(comm, 9999, 0) from emp;
```
![image](https://github.com/user-attachments/assets/51a78bc7-9636-404d-96cc-b3d45277afc2)
```sql
...
```
![image](https://github.com/user-attachments/assets/a85558f8-2b6c-47aa-930e-321192e81e72)
- trunc(): 버림
```spl
select trunc(3.141592, 2), trunc(3.141592, 3) from dual;  # trunc는 무조건 잘라버림. 결과(3.14, 3.141)
```
![image](https://github.com/user-attachments/assets/9901813a-1a99-42c1-beb2-174a26133b75)
...
from emp;
```
![image](https://github.com/user-attachments/assets/ad521073-40f9-4cb3-a771-02a2dc89ec91)
...
from emp;
```
![image](https://github.com/user-attachments/assets/4fe18245-f794-4c81-bcd9-8bb18ae0e7f2)
```sql
...
from emp;
```
![image](https://github.com/user-attachments/assets/f8db406f-7031-4f87-9c17-3e42404fa2a0)
# function_groupby
...
```
![image](https://github.com/user-attachments/assets/b092205d-0b58-4150-ae05-4757dd77c69e)
  - 통계 함수: null을 제외하고 계산
  - sum(): 합계
  - avg(): average, 평균
  - variance(): 분산
...
from emp;
```
![image](https://github.com/user-attachments/assets/5ceae466-8cee-4267-8260-e0e4e7b00862)
...
order by deptno;  # 4
```
![image](https://github.com/user-attachments/assets/69579fce-a405-4960-9561-a45a08937b80)
```sql
# 부서별 급여 평균
...
order by deptno;
```
![image](https://github.com/user-attachments/assets/0a3c019b-bfa2-4e40-b5ba-491acba13120)
```sql
...
order by deptno;
```
![image](https://github.com/user-attachments/assets/ed1e49fd-f8b2-4d96-a1ff-8f0abbdfc4df)
```sql
...
order by deptno;
```
![image](https://github.com/user-attachments/assets/2d44e21c-93ec-4fb3-ad9f-f70cda6a8d62)
```sql
...
order by job;
```
![image](https://github.com/user-attachments/assets/19fa9cff-4c11-4da1-bec7-babb0cb58a3f)
```sql
...
order by deptno, job;
```
![image](https://github.com/user-attachments/assets/32bbecfb-4f53-47da-a6e2-5ca3974a8f42)
...
```
![image](https://github.com/user-attachments/assets/0cbeeca4-12c9-4d42-befd-7b947e0ba8c2)
```sql
# 오류나는 문장
select job, count(*) as "COUNT"
from emp
...
```
![image](https://github.com/user-attachments/assets/75ac5772-5b54-4818-9458-c50466b6b91c)
```sql
# 입사연도별 직원수를 출력
select
...
order by "YEAR";
```
![image](https://github.com/user-attachments/assets/22dc3c90-2324-4a63-adb9-6050764f8841)
...
```
![image](https://github.com/user-attachments/assets/3a38895a-31a5-4579-b74d-1221a53ca29e)
```sql
# 부서별 급여 합계
...
order by deptno;
```
![image](https://github.com/user-attachments/assets/4d6e4b85-8bf6-47c6-80d3-ab60858b2ef7)
```sql
...
from emp;
```
![image](https://github.com/user-attachments/assets/ec3811e7-9c67-4cbb-bd65-ca325ac0305a)
