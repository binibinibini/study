...
```python
# 거래 금액 상위 10개
seoul_top10 = seoul_mid_size_by_county.sort_values(by = 'mean', ascending = False).head(n = 10)
sns.barplot(data = seoul_top10, x = 'mean', y = 'county')
plt.show()
```
![image](https://github.com/user-attachments/assets/ba3e5138-b022-424a-bd9e-d28a6035b4e6)

# 광역시도별 아파트 실거래가 분석
```python
apt_by_province = apt_t.pivot_table(value = '거래금액(만원',
                                    index = 'province',
                                    aggfunc = {'거래금액(만원)': ['count', 'mean', 'max', 'min']})
apt_by_province
```
![image](https://github.com/user-attachments/assets/372952ef-a537-422e-a450-da9ba25cd460)

## 거래 건수 상위 10개 광역시도

```python
top10 = apt_by_province.sort_values(by = 'count', ascending = False).head(n = 10)
sns.barplot(data = top10, x = 'count', y = 'province')
plt.show()
```
![image](https://github.com/user-attachments/assets/e0fba61e-9e0d-4c59-9bdb-fb70891363a6)
...
plt.show()
```
![image](https://github.com/user-attachments/assets/438f2805-e50b-4d6a-bc58-ee736399f5d1)

## 전용면적 $84 m^2$ 이상 $100 m^2$ 미만의 전국 광역시도별 아파트

```python
mid_size = apt_t[(apt_t['전용면적'] >= 84) &
                 (apt_t['전용면적'] < 100)]
mid_size.head()
```
![image](https://github.com/user-attachments/assets/f27b20aa-ad5b-41ca-9294-1bbe2c1087ab)

```python
mid_size_by_province = mid_size.pivot_table(values = '거래금액(만원)',
                                            index = 'province',
                                            aggfunc = {'거래금액(만원)': ['count', 'mean', 'max', 'min']})
mid_size_by_province
```
![image](https://github.com/user-attachments/assets/6836f68a-c367-41d5-9b48-529ec74521ed)
...
plt.show()
```
![image](https://github.com/user-attachments/assets/10f0bb43-e1ee-45b4-9082-35b93a868c65)
...
plt.show()
```
![image](https://github.com/user-attachments/assets/921d5171-57c7-40fe-a4bf-ca36eaf5e0b5)

```python
fig = plt.figure(figsize = (20, 5))
sns.boxplot(data = apt_t, x = 'province', y = '거래금액(만원)')
plt.show()
```
![image](https://github.com/user-attachments/assets/7f47de28-894d-46b4-ae5b-512361e16177)
