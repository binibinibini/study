...
![image](https://github.com/user-attachments/assets/59bbc1e9-21f6-4fa7-8590-91fc5abcfe4b)
<br>
```python
...
s.loc['c':'x':+1]
```
![image](https://github.com/user-attachments/assets/d969aca4-5e6b-4daf-a6f5-d2c7b21a042e)
```python
s.loc[:'x':-1]
```
![image](https://github.com/user-attachments/assets/3fd65afa-f697-4824-9838-84e7a99ad4a8)
```python
s.loc['x'::-1]
```
![image](https://github.com/user-attachments/assets/cb98d462-6add-4f4c-8d42-d77cef8d054d)
<br>
# DataFrame
- 테이블 형식의 2차원 데이터 타입
...
data
```
![image](https://github.com/user-attachments/assets/24a63a1c-a394-4737-b163-3d2c009c22c2)
```python
df = pd.DataFrame(data)
print(df)  # __str__() 메서드가 리턴하는 문자열
```
![image](https://github.com/user-attachments/assets/2cb8c4ef-ff2a-43f3-8471-3f8523ddb93a)
```python
df
```
![image](https://github.com/user-attachments/assets/b901e0e7-370d-413c-9a2a-43ea1963d6cb)
<br>
## DataFrame의 속성들
```python
print('shape:', df.shape)  # shape(모양): (row 갯수, column 갯수)
print('index:', df.index)  # index: row index. 행의 레이블.
print('columns:', df.columns)  # columns: column index. 열 레이블(이름). object는 문자열 타입이라고 생각하면 됨.
```
![image](https://github.com/user-attachments/assets/31324e14-1cf5-4b7c-b149-91f00d6133ea)
```python
print(df.values)  # values: 데이터프레임의 값들로만 이루어진 2차원 np.ndarray. 행들을 1차원 배열로
```
![image](https://github.com/user-attachments/assets/7613a96f-3bd9-47a5-870c-6c9306fe0355)
<br>
...
```
![image](https://github.com/user-attachments/assets/c9caf26a-7f4f-4186-ba15-be1dd192abf2)
```python
df.city
```
![image](https://github.com/user-attachments/assets/eb9c01bf-5801-4bba-a5b1-230699a41038)
```python
df['pop']
```
![image](https://github.com/user-attachments/assets/6f9c02ae-acf8-4494-be73-c869b944bd75)
```python
df.pop  # pop는 DataFrame 클래스의 pop 메서드 객체. 이런 경우 위에 있는 방법으로 밖에 안됨.
```
![image](https://github.com/user-attachments/assets/269b9fcd-9969-44d7-9fe9-a4bf4e1bfb37)
```python
# 데이터프레임에서 2개 이상의 열(column)을 선택
df[['year', 'pop']]    # select year, pop from df;
```
![image](https://github.com/user-attachments/assets/132bbebf-c861-4e78-9fac-820c59843658)
```python
df[['year', 'city', 'pop']]
```
![image](https://github.com/user-attachments/assets/be221ae4-6ab2-4845-a7aa-f3c90fb163cc)
